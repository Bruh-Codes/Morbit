...
import { ENABLE_TESTNET, FORK_ENABLED, isFeatureEnabled } from 'utils/marketsAndNetworksConfig';
  ...
  return (
    <HideOnScroll>
      ...
      >
        ...
        >
          <img src={uiConfig.appLogo} alt="Morbit" width={72} height={40} />
        </Box>
        <Box sx={{ mr: sm ? 1 : 3 }}>
          {ENABLE_TESTNET && (
            <ContentWithTooltip tooltipContent={testnetTooltip} offset={[0, -4]} withoutHover>
              <Button
                ...
                sx={{
                  backgroundColor: '#CCFF00',
                  '&:hover, &.Mui-focusVisible': { backgroundColor: '#B8E600' },
                }}
              >
                TESTNET
