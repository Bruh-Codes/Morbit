...
export const getDesignTokens = (mode: 'light' | 'dark') => {
  ...
  return {
    ...
    palette: {
      mode,
      primary: {
        main: getColor('#0A0A0A', '#FFFFFF'),
        light: getColor('#333333', '#E0E0E0'),
        dark: getColor('#000000', '#B0B0B0'),
        contrast: getColor('#FFFFFF', '#0A0A0A'),
      },
      secondary: {
        main: '#CCFF00',
        light: '#D9FF4D',
      ...
      error: {
        ...
        '200': getColor('#F9EBEB', '#1A0A0A'), // for alert background
      },
      warning: {
        ...
        '200': getColor('#FEF5E8', '#1A1206'), // for alert background
      },
      info: {
        ...
        '200': getColor('#E5EFFB', '#0A1520'), // for alert background
      },
      success: {
        main: getColor('#4CAF50', '#CCFF00'),
        light: getColor('#90FF95', '#D9FF4D'),
        dark: getColor('#318435', '#A3CC00'),
        '100': getColor('#1C4B1E', '#E5FF99'), // for alert text
        '200': getColor('#ECF8ED', '#0F1A00'), // for alert background
      },
      text: {
        primary: getColor('#0A0A0A', '#FFFFFF'),
        secondary: getColor('#555555', '#A0A0A0'),
        disabled: getColor('#BDBDBD', '#555555'),
        muted: getColor('#888888', '#707070'),
        highlight: getColor('#8FAD00', '#CCFF00'),
      },
      background: {
        default: getColor('#FAFAFA', '#0A0A0A'),
        paper: getColor('#FFFFFF', '#111111'),
        surface: getColor('#F5F5F5', '#1A1A1A'),
        surface2: getColor('#EEEEEE', '#1A1A1A'),
        header: getColor('#0A0A0A', '#0A0A0A'),
        disabled: getColor('#E0E0E0', '#FFFFFF14'),
      },
      divider: getColor('#E0E0E0', 'rgba(255, 255, 255, 0.08)'),
      action: {
        active: getColor('#888888', 'rgba(255, 255, 255, 0.56)'),
        hover: getColor('#F5F5F5', 'rgba(255, 255, 255, 0.08)'),
        selected: getColor('#E0E0E0', 'rgba(255, 255, 255, 0.16)'),
        disabled: getColor('#BDBDBD', 'rgba(255, 255, 255, 0.3)'),
        disabledBackground: getColor('#E0E0E0', 'rgba(255, 255, 255, 0.12)'),
        focus: getColor('#F5F5F5', 'rgba(255, 255, 255, 0.12)'),
      },
      other: {
        standardInputLine: getColor('rgba(0, 0, 0, 0.12)', 'rgba(255, 255, 255, 0.42)'),
      },
      gradients: {
        morbitGradient: '#CCFF00',
        newGradient: '#CCFF00',
      },
    },
    spacing: 4,
